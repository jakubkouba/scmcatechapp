module Admin
  class PupilsController < ApplicationController
    ...
    def destroy
      @pupil.destroy
      respond_to do |format|
        format.html { redirect_to admin_pupil_url, notice: 'Pupil was successfully destroyed.' }
    ...
    private
      ...
      def set_pupil
        @pupil = Admin::Pupil.find(params[:id])
      end

      # Never trust parameters from the scary internet, only allow the white list through.
      def pupil_params
        params.require(:admin_pupil).permit(:name, :surname, :description, :points_total)
      end
  end
end
